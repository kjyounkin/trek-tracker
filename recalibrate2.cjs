...
// The 8 anchors provided by user (Lat, Lng) with exact milestone miles
const anchors = [
  { mile: 0, latLng: [-72.57, 55.67] }, // Hobbiton
  { mile: 135, latLng: [-72.89, 67.16] }, // Bree
  { mile: 460, latLng: [-71.54, 94.34] }, // Rivendell
  { mile: 745, latLng: [-87.54, 90.22] }, // Gates of Moria
  { mile: 865, latLng: [-94.14, 104.09] }, // Leaving Lothlorien
  { mile: 1100, latLng: [-108.79, 114.66] }, // Paddling down the Anduin
  { mile: 1250, latLng: [-118.51, 114.44] }, // Amon Hen
  { mile: 1380, latLng: [-116.98, 123.47] }, // Dead Marshes
